...
final class DataProviderTests: XCTestCase {
    ...
    func testCellForRowInSectionZeroCallsConfigure() {
        ...
        let cell = tableView.cellForRow(at: IndexPath(item: 0, section: 0)) as! MockTaskCell
    ...
    func testCellForTowInSectionOneCallsConfigure() {
        ...
        let cell = tableView.cellForRow(at: IndexPath(item: 0, section: 1)) as! MockTaskCell
